/*------------------------------------------------------------------------
Copyright (c) 2008-2026 SIL Global. All rights reserved.
...
#define VER_FILEVERSION             2,5,13,0
#define VER_FILEVERSION_STR         "2.5.13.0\0"

#define VER_PRODUCTVERSION          2,5,13,0
#define VER_PRODUCTVERSION_STR      "2.5.13\0"

// constants used in all the binaries, shouldn't need changing (until next year)
#define VER_COMPANY_NAME_STR        "SIL Global\0"
#define VER_COPYRIGHT_STR           "Copyright (c) 2002-2026\0"
